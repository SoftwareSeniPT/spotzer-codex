...
### Other Brand colors are incorporated into background, headlines, subtitles, menu, dividers, etc. 
### Logo is clickable to home
...
### Call to Action is in header, and repeated below the fold (except on contact) 
### Alignment is correct (verified with cross-browser previewing)
